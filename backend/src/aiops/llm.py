    ...
    if _llm_enabled():
        try:
                ...
                messages: list[Any] = [
                    SystemMessage(
                        content=(
                            ...
                            "INTERFACE EVENTS: If the incident involves an interface (event_family=interface or a specific interface is mentioned), "
                            "ALWAYS run 'show interfaces description' as your FIRST command. "
                            "This reveals the operational role of every interface (e.g. WAN uplink, backup link, unused port) "
                            "so you can correctly assess the business impact and severity of the affected interface. "
                            "TOOL RULES: "
                            ...
                            "Preferred commands: 'show interfaces description', 'show interface <intf>', "
                            "'show ip ospf neighbor', 'show ip bgp summary', 'show ip eigrp neighbors', "
                            "'show track', 'show ip route'. "
            ...
            synthesis_prompt = (
                ...
                "---\n"
                "INTERFACE ROLE CONTEXT: If 'show interfaces description' output is present in the CLI evidence above, "
                "use the description of the affected interface to assess business impact. "
                "For example: description 'WAN-TO-ISP-TRUE' → internet/upstream loss (high impact). "
                "description 'BACKUP-LINK' → secondary path (lower urgency). "
